...
* （Android 8.0+，Sui 12.1+）在桌面长按系统设置图标，会看到 Sui 的快捷方式
* （Android 8.0+，Sui 12+）进入系统设置的 “开发者选项（Developer options）”，系统会提示你添加 Sui 快捷方式
* 在默认拨号器中输入 `*#*#784784#*#*`

注意：快捷方式方式依赖桌面（Home App）对 Android 7.0/8.0 引入的快捷方式 APIs 的支持。除非你用的是很老的桌面应用，否则一般都可以正常添加。
